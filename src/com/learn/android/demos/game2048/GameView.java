...
public class GameView extends LinearLayout {
	...
	public void startGame(){
		...
		Game2048Activity aty = Game2048Activity.getMainActivity();
		aty.clearScore();
...
//			cardsMap[p.x][p.y].setNum(2048);

			Game2048Activity.getMainActivity().getAnimLayer().createScaleTo1(cardsMap[p.x][p.y]);
		}
	}
				...
				for (int x1 = x+1; x1 < Config.LINES; x1++) {
					if (cardsMap[x1][y].getNum()>0) {
						...
						if (cardsMap[x][y].getNum()<=0) {
							...
							Game2048Activity.getMainActivity().getAnimLayer().createMoveAnim(cardsMap[x1][y],cardsMap[x][y], x1, x, y, y);
			...
			for (int y = 0; y < Config.LINES; y++) {
				...
				for (int y1 = y+1; y1 < Config.LINES; y1++) {
					if (cardsMap[x][y1].getNum()>0) {
						...
						if (cardsMap[x][y].getNum()<=0) {
							Game2048Activity.getMainActivity().getAnimLayer().createMoveAnim(cardsMap[x][y1],cardsMap[x][y], x, x, y1, y);
